    ...
    <div className="p-3 md:p-5 flex flex-col gap-4 h-full overflow-auto">
      ...
      <div className="flex gap-4 flex-col xl:flex-row flex-1">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3">
          ...
          {/* Search */}
          <div className="glass rounded-2xl p-4 relative z-30">
            <div className="relative" ref={sugRef}>
              ...
              {showSug && suggestions.length > 0 && (
                <div className="absolute top-full mt-1 left-0 right-0 glass rounded-xl overflow-hidden z-40 shadow-2xl border border-white/10">
